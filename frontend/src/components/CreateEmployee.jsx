...
const CreateEmployee = () => {
    ...
    let formHandle = (e) => {
        ...
        return (
            <div className=' max-w-[940px]  h-[600px] border-4 border-black mx-auto relative top-[-80px] shadow-xl scale-75 p-[30px]'>
                <h1 className='text-center font-bold text-2xl my-3'>Create Employee</h1>
                <div className='border border-black max-w-[300px] mx-auto my-5 p-8'>
                    <input className='bg-white border-2 border-black text-black my-3 placeholder-black ' placeholder='Enter Full Name' type="text" value={name} onChange={(e) => { setName(e.target.value) }} />
                    <input className='bg-white border-2 border-black text-black my-3 placeholder-black ' placeholder='Enter Email' type="text" value={email} onChange={(e) => { setEmail(e.target.value) }} />
                    <input className='bg-white border-2 border-black text-black my-3 placeholder-black ' placeholder='Enter Phone Number' type="text" value={phone} onChange={(e) => { setPhone(e.target.value) }} />
                    ...
                    <button className='bg-cyan-300 ml-5 rounded-lg p-1' onClick={formHandle}>Register Me</button>
                </div>
